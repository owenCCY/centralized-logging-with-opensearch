...
if ( ($CURRENT_REGION -eq "cn-northwest-1") -or ($CURRENT_REGION -eq "cn-north-1") ) {
  curl -o C:/fluent-bit-2.2.0-win64.zip https://aws-solutions-assets.s3.cn-north-1.amazonaws.com.cn/clo/v2.2.0/fluent-bit-2.2.0-win64.zip
}
else {
  #download and install FluentBit from China Region
  curl -o C:/fluent-bit-2.2.0-win64.zip https://releases.fluentbit.io/2.2/fluent-bit-2.2.0-win64.zip
}
