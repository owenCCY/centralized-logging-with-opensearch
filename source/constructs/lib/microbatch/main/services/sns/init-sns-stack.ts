...
export class InitSNSStack extends Construct {
    ...
    constructor(scope: Construct, id: string, props: InitSNSProps) {
      ...
      const cfnSNSReceiveStatesFailedTopic = this.SNSReceiveStatesFailedTopic.node.defaultChild as sns.CfnTopic;
      ...
      // Override the logical ID
      const cfnSNSSendEmailTopic = this.SNSSendEmailTopic.node.defaultChild as sns.CfnTopic;
